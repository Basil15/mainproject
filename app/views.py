...
from app.models import product, Customer, Order, Complaint,Review
...
def user_view(request):
    customer = Customer.objects.filter(is_user=True)
...
def view_review(request):
    ...
    return render(request,'admin_panel/review_manage.html',{'r':r})
