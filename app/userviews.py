...
def profile_update(request,id):
    ...
    form = CustomerForm(request.POST or None, instance=profile or None)
...
#     profile = Customer.objects.get(id=id)
#     if request.method == 'POST':
#         form = CustomerForm(request.POST or None,instance=profile)
#         if form.is_valid():
#             form.save()
#             return redirect('user_profile')
#         else:
#             form=CustomerForm(request.POST)
#     return render(request,'user_panel/user_profile_update.html')
#

@login_required()
def user_product_view(request):
    p = product.objects.all()
    Prodfiltr=ProductFilter(request.GET,queryset=p)
    return render(request, 'user_panel/user_product_view.html', {'p': p,'Prodfiltr':Prodfiltr})
